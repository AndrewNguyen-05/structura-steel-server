...
VALUES
    ...
    -- Ghi chú: Trọng lượng (unit_weight) là kg/cây 11.7m. Giá được tính trên mỗi cây.
    -------------------------------------------------------------------------------
    ...
    ('2025-07-07 08:40:00+00','System','2025-07-07 08:40:00+00','System',1,
     ...
     18,NULL,NULL,NULL,
     350550, 0.15, 403132, FALSE),

    -------------------------------------------------------------------------------
    -- NHÓM 2: THÉP TẤM (PLATE) - THEO JIS G3101
    -- Ghi chú: Trọng lượng (unit_weight) là kg/m. Giá được tính trên mỗi mét dài.
    -------------------------------------------------------------------------------
    ('2025-07-07 10:00:00+00','System','2025-07-07 10:00:00+00','System',1,
     'PRD20250707PLAT10T','Thép tấm 10ly x 3m','PLATE','JIS G3101',235.5,50000,
     NULL,3000,NULL,10,
     3532500, 0.15, 4062375, FALSE),
    ('2025-07-07 10:10:00+00','System','2025-07-07 10:10:00+00','System',1,
     'PRD20250707PLAT12T','Thép tấm 12ly x 3m','PLATE','JIS G3101',282.6,50000,
     NULL,3000,NULL,12,
     4239000, 0.15, 4874850, FALSE),
    ('2025-07-07 10:20:00+00','System','2025-07-07 10:20:00+00','System',1,
     'PRD20250707PLAT14T','Thép tấm 14ly x 3m','PLATE','JIS G3101',329.7,50000,
     NULL,3000,NULL,14,
     4945500, 0.15, 5687325, FALSE),
    ...
    ('2025-07-07 13:00:00+00','System','2025-07-07 13:00:00+00','System',1,
     'PRD20250707BOX10010','Thép hộp vuông 100x100x10','BOX','JIS G3466',29.29,100000,
     NULL,100,100,10,
     439350, 0.15, 505252, FALSE),
    ('2025-07-07 13:10:00+00','System','2025-07-07 13:10:00+00','System',1,
     'PRD20250707BOX15010','Thép hộp vuông 150x150x10','BOX','JIS G3466',45.09,100000,
     NULL,150,150,10,
     676350, 0.15, 777802, FALSE),
    ('2025-07-07 13:20:00+00','System','2025-07-07 13:20:00+00','System',1,
     'PRD20250707BOX20010','Thép hộp vuông 200x200x10','BOX','JIS G3466',61.02,100000,
     NULL,200,200,10,
     915300, 0.15, 1052595, FALSE),
    ...
    ('2025-07-07 14:30:00+00','System','2025-07-07 14:30:00+00','System',1,
     'PRD20250707SHPI150','Thép hình I 150x75x5','SHAPED','JIS G3192',14.0,50000,
     NULL,75,150,5,
     210000, 0.15, 241500, FALSE),
    ('2025-07-07 14:40:00+00','System','2025-07-07 14:40:00+00','System',1,
     'PRD20250707SHPI200','Thép hình I 200x100x5.5','SHAPED','JIS G3192',21.3,50000,
     NULL,100,200,5.5,
     319500, 0.15, 367425, FALSE),
    ('2025-07-07 14:50:00+00','System','2025-07-07 14:50:00+00','System',1,
     'PRD20250707SHPI300','Thép hình I 300x150x6.5','SHAPED','JIS G3192',36.7,50000,
     NULL,150,300,6.5,
     550500, 0.15, 633075, FALSE)
;